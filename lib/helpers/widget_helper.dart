...
class WidgetUtil {
  ...
  static ButtonStyle get basicButtonStyle => ElevatedButton.styleFrom(
    backgroundColor: const Color.fromARGB(255, 85, 146, 246),
  ...
  static Text middleText(String text, {Color color = const Color(0xFF1d1d1d), TextAlign? textAlign = TextAlign.start, double? fontSize = 18, FontWeight? fontWeight = FontWeight.normal}) {
    return Text(
      text,
      textAlign: textAlign,
      style: TextStyle(
        ...
        child: SizedBox(
          ...
          child: ElevatedButton(
            style: ElevatedButton.styleFrom(
              backgroundColor: const Color(0xFF108f10),
              foregroundColor: Colors.white,
              shape: RoundedRectangleBorder(
  ...
  static DateTime? parseDatetime(String datetimeStr, {String format = 'y/M/d HH:mm:ss'}) {
    DateTime? result;
    var formatter = DateFormat(format, "ja_JP");

    // String→DateTime変換
    try {
      return formatter.parseStrict(datetimeStr);
