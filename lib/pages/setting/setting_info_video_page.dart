...
class SettingInfoVideoPage extends StatefulWidget {

  @override
  SettingInfoVideoPageState createState() => SettingInfoVideoPageState();
}

class SettingInfoVideoPageState extends State<SettingInfoVideoPage> {
  bool _loading = false;
  var _init = true;
  List<dynamic> _data = [];
  var _selectId = '';
  ...
  Future<void> _getData() async {
    ...
    var url = '${AppDefine.baseURL}app/info_video_list?code=${code}&token=${AppManager.settings['api_token']}';
  ...
  Future<void> _selectVideo(id) async {
    ...
    final code = AppManager.isManager ? AppManager.selectCode : AppManager.delegatorCode;
    var url = "${AppDefine.baseURL}app/info_video_sel?id=$id&code=${code}&token=${AppManager.settings['api_token']}";
