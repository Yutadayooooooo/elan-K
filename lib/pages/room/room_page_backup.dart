...
class _RoomPageState extends State<RoomPage>
  ...
  Widget build(BuildContext context) {
    ...
    const menuButtonHeight = 72.0;//80　高さ　20241223
    const menuButtonMargin = 400.0;//8.0　間隔　20241223
    const menuButtonFontSize = 42.0;//30.0　文字サイズ　20241223
                          ...
                          children: [
                            ...
                            SizedBox(
                              ...
                              child: ElevatedButton(
                                ...
                                child: WidgetUtil.middleText('設定', fontSize: menuButtonFontSize, color: Color.fromARGB(255, 100, 100, 100),),
                              ),
                            ),
                          ],
                        ),
