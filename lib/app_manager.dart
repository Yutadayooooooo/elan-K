...
class AppManager {
  ...
  static dynamic appsettings = {
    ...
    "CLOCKDISP": "0", "DISPLAYNUM": "3", "CALLSTATUSDISP": "0", "MUTE": "0",
  ...
  static void clearAddress(context) {
    context.read<AddressStore>().clear();
  }

  static void loadAddress(context) {
  ...
  static String webLiveImageIntervalText(String type) {
    if (type == '1') {
      return '10秒';
    }
    else if (type == '2') {
  ...
  static int webLiveImageInterval(String type) {
    if (type == '1') {
      return 10;
    }
    else if (type == '2') {
