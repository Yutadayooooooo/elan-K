...
Widget wrapWithModel<T extends MyModel>({
  required T model,
...
T createModel<T extends MyModel>(
...
abstract class MyModel<W extends Widget> {
...
class MyDynamicModels<T extends MyModel> {
  MyDynamicModels(this.defaultBuilder);
